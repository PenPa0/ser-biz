...
const SignUp = () => {
  ...
  const replaceNames = (propertyName, e) => {
    let value = e;

    value = value.replace(/[^A-Za-z\s]/gi, ""); //regular expression
    setRegister({ ...register, [propertyName]: value });
  };
                ...
                <div>
                    ...
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        ...
                        <input
                          ...
                          // }}
                          onChange={(e) =>
                            replaceNames("first_name", e.target.value)
                          }
                          type="text"
                    ...
                    <div className="w-1/2 px-3 mb-5">
                      ...
                      <div className="flex">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            replaceNames("last_name", e.target.value)
                          }
                          type="text"
                          className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                          placeholder="Smith"
                      ...
                      <div className="flex">
                        ...
                        <input
                          onChange={(e) => {
                            ...
                            setRegister({ ...register, user_email: value });
                          }}
                          type="email"
                          className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button
                        type="submit"
                        className="lock w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                        // onClick={() => {
